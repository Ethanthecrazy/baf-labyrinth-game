...
//the type of object
enum UNIT_TYPES { OBJECT_TILE, OBJECT_BUTTON, OBJECT_OBJECT, OBJECT_ENTITY, OBJECT_LIGHT };
...
//huge list of types
enum OBJECT_TYPES {ENT_PLAYER, ENT_GOLEM, OBJ_EXIT , OBJ_SPAWNER , OBJ_DOOR , OBJ_BUTTON , OBJ_ATTRACTOR , OBJ_POWERGLOVES , OBJ_OILCAN};
//all of our golems
